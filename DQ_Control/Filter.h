...
inline void Compute_2nd_Filter(volatile SECOND_ORDER_FILTER *Filter, float x_k,const float *FILTER_COEFF) {
...
inline void Compute_1st_Filter(volatile FIRST_ORDER_FILTER *Filter, float x_k,const float *FILTER_COEFF) {
...
inline void Integrator_mod_2_pi(volatile FIRST_ORDER_FILTER *Filter, float x_k,const float *FILTER_COEFF) {
