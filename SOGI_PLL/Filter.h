...
static inline void Compute_2nd_Filter(volatile SECOND_ORDER_FILTER *Filter, double x_k,const double *FILTER_COEFF) {
...
static inline void Compute_1st_Filter(volatile FIRST_ORDER_FILTER *Filter, double x_k,const double *FILTER_COEFF) {
    Filter->x[0] = x_k;         //x(k)
...
static inline void Integrator_mod_2_pi(volatile FIRST_ORDER_FILTER *Filter, double x_k,const double *FILTER_COEFF) {
