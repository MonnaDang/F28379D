...
//    Compute_delta_2nd_filter(&Delta_alpha);
    Init_Delta_Filter(&Delta_beta, PR_COEFF, Delta);
//    Compute_delta_2nd_filter(&Delta_beta);
...
//         RUN          //
    ...
    if(MY_ST.CANRUN&MY_ST.CONTROL){
        ...
        if(MY_ST.Pref < -500) MY_ST.Pref = -300;
...
//        Delta_alpha.X_k = Err_alpha;
//        Compute_delta_2nd_filter(&Delta_alpha);
//        Delta_beta.X_k  = Err_beta;
//        Compute_delta_2nd_filter(&Delta_beta);
//
        // Alpha beta to ABC
        Va_l = PR_ALPHA.y[0];
        ...
        // Alpha beta to ABC
//        Va_l = Delta_alpha.Y_k;
//        Vb_l = (-Delta_alpha.Y_k/2+SQRT_3/2*Delta_beta.Y_k);
//        Vc_l = (-Delta_alpha.Y_k/2-SQRT_3/2*Delta_beta.Y_k);
