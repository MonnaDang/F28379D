...
//         RUN          //
    ...
    if(MY_ST.CANRUN&MY_ST.CONTROL){
        ...
        sqr_Vmax = Vd*Vd + Vq*Vq+0.00001;
        Id_ref = 0.666666666666667*(MY_ST.Pref*Vd+MY_ST.Qref*Vq)/sqr_Vmax;
        Iq_ref = 0.666666666666667*(MY_ST.Pref*Vq-MY_ST.Qref*Vd)/sqr_Vmax;
    ...
    switch (Test_mode) {
        ...
        case 1:
            OUT_DATA = Iam;
            DacbRegs.DACVALS.all = THETA*200;                                       // Load output A value
            DacaRegs.DACVALS.all = AdcaResultRegs.ADCRESULT1;                       // Load output B value
            break;
        case 2:
            OUT_DATA = Ibm;
            DacbRegs.DACVALS.all = THETA*200;                                       // Load output A value
            DacaRegs.DACVALS.all = AdccResultRegs.ADCRESULT1;                       // Load output B value
            break;
        case 3:
            OUT_DATA = Icm;
            DacbRegs.DACVALS.all = THETA*200;                                       // Load output A value
            DacaRegs.DACVALS.all = AdcbResultRegs.ADCRESULT1;                       // Load output B value
            break;
        case 4:
            OUT_DATA = VA;
            DacbRegs.DACVALS.all = THETA*200;                                       // Load output A value
        ...
        case 7:
            OUT_DATA = VABC.P_m;
            DacbRegs.DACVALS.all = MY_ST.Pref*5+2048;                              // Load output A value
            DacaRegs.DACVALS.all = VABC.P_m*5+2048;                                  // Load output B value
            break;
        case 8:
            OUT_DATA = VABC.Q_m;
            DacbRegs.DACVALS.all = MY_ST.Qref*5+2048;                              // Load output A value
            DacaRegs.DACVALS.all = VABC.Q_m*5+2048;                                  // Load output B value
            break;
        case 9:
            OUT_DATA = Id_m;
            DacbRegs.DACVALS.all = Id_ref*100+2048;                              // Load output A value
            DacaRegs.DACVALS.all = Id_m*100+2048;                      // Load output B value
            break;
        case 10:
            OUT_DATA = Iq_m;
            DacbRegs.DACVALS.all = Iq_ref*100+2048;                              // Load output A value
            DacaRegs.DACVALS.all = Iq_m*100+2048;                      // Load output B value
            break;
        case 11:
            OUT_DATA = Id_ref;
            DacbRegs.DACVALS.all = Id_ref*100+2048;                              // Load output A value
        ...
        case 12:
            ...
            break;
        case 13:
            OUT_DATA = Delta_alpha.Y_k;
            DacbRegs.DACVALS.all = Id_ref*100+2048;                              // Load output A value
            DacaRegs.DACVALS.all = Id_m*100+2048;                      // Load output B value
            break;
        case 14:
            OUT_DATA = Delta_beta.Y_k;
            DacbRegs.DACVALS.all = Iq_ref*100+2048;                              // Load output A value
            DacaRegs.DACVALS.all = Iq_m*100+2048;                      // Load output B value
            break;
        case 15:
            OUT_DATA = EPwm1Regs.CMPA.bit.CMPA;
            DacbRegs.DACVALS.all = Va_l*100+2048;                              // Load output A value
            DacaRegs.DACVALS.all = Va_l*100+2048;                      // Load output B value
            break;
        case 16:
            OUT_DATA = EPwm2Regs.CMPA.bit.CMPA;
            DacbRegs.DACVALS.all = Vb_l*100+2048;                              // Load output A value
            DacaRegs.DACVALS.all = Ibeta_measurement*100+2048;                      // Load output B value
            break;
        case 17:
            OUT_DATA = EPwm3Regs.CMPA.bit.CMPA;
            DacbRegs.DACVALS.all = Vc_l*100+2048;                              // Load output A value
            DacaRegs.DACVALS.all = Ibeta_measurement*100+2048;                      // Load output B value
            break;
        case 18:
            OUT_DATA = Va_l;
